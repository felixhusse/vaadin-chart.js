# Chart.js Add-on for Vaadin 7

This is an UI component add-on for Vaadin 7 based on the Chart.js Java Script library ([Chart.js](http://www.chartjs.org/)). Chart.js version in use is 1.0.1-beta.4.
...
The issues for this add-on are tracked on [github.com](https://github.com/felixhusse/vaadin-chart.js/issues). All bug reports and feature requests are appreciated.
